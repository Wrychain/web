...
namespace Wrychain.DAL.Migrations
{
    ...
    [Migration("20251117000719_ip_and_user_agent_to_login_attempt_entity")]
    partial class ip_and_user_agent_to_login_attempt_entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MessageMessage", b =>
                {
                    b.Property<int>("ChildRepliesId")
                        .HasColumnType("int");

                    b.Property<int>("ParentRepliesId")
                        .HasColumnType("int");

                    b.HasKey("ChildRepliesId", "ParentRepliesId");

                    b.HasIndex("ParentRepliesId");
            ...
            modelBuilder.Entity("Wrychain.DAL.Entity.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wrychain.DAL.Entity.Categories.CategoryChannel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wrychain.DAL.Entity.Channels.ChannelReader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ChannelReader");
                });

            modelBuilder.Entity("Wrychain.DAL.Entity.Channels.ChannelWriter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ChannelWriter");
                });

            modelBuilder.Entity("Wrychain.DAL.Entity.Channels.Presence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wrychain.DAL.Entity.Channels.Progress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wrychain.DAL.Entity.Invites.ChannelInvite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wrychain.DAL.Entity.Stations.StationChannel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StationChannel");
                });

            modelBuilder.Entity("Wrychain.DAL.Entity.Stations.StationDefaultCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StationDefaultCategory");
                });

            modelBuilder.Entity("Wrychain.DAL.Entity.Stations.StationUserCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MessageMessage", b =>
                {
                    b.HasOne("Wrychain.DAL.Entity.Messages.Message", null)
                        .WithMany()
                        .HasForeignKey("ChildRepliesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Wrychain.DAL.Entity.Messages.Message", null)
                        .WithMany()
                        .HasForeignKey("ParentRepliesId")
            ...
            modelBuilder.Entity("Wrychain.DAL.Entity.Categories.CategoryChannel", b =>
                {
                    b.HasOne("Wrychain.DAL.Entity.Categories.Category", "Category")
